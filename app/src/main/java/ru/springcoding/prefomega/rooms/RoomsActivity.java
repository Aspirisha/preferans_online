...
public class RoomsActivity extends FragmentActivity implements OnClickListener {
    ...
    private int currentSelectedRoomIndex = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFullRoomInfo = (Button) findViewById(R.id.button_show_full_info);
        ...
        btnFullRoomInfo.setOnClickListener(this);
        btnFullRoomInfo.setEnabled(false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.buttonConnectToRoom:
                ...
                PrefApplication.sendData(nameValuePairs, false);
                break;
            case R.id.button_show_full_info:

                showDialog(rooms.get(currentSelectedRoomIndex - 1));
                break;
        }
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        switch (msgType) {
            case ROOMS_EXISTING_ROOMS: // roomsData is got
                ...
                Gson gson = new Gson();
                try {
                    Type collectionType = new TypeToken<LinkedList<RoomInfo>>() {
                    }.getType();
    ...
    class TableClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (newId != prevSelectedId) {
                ...
                btnFullRoomInfo.setEnabled(true);
                if (selectedRoomId != -1) {

                    currentSelectedRoomIndex = contentTable.indexOfChild(tRow);
